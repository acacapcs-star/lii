...
首頁另有可拖曳的 Luna Pacer 浮球(夜空與玻璃兩面,可左右滑動轉面),以及水晶收藏:6 顆,ice 起始、sea 3 次呼吸、amethyst 7 次、amber 14 次、moss 連續 3 天、dawn 連續 7 天,系統會提示下一顆還差多少。浮球點下去的呼吸方式依 ERS 決定，門檻和 ERS 引擎、首頁狀態文字同一組(0–44 綠、45–69 黃、70 以上紅)。點兩下浮球會叫出 Joy-Con 樣式的控制器,固定在畫面下方中間:左邊搖桿移動位置(推越遠走越快),右邊按住「＋」「－」連續放大縮小,◎ 回到預設位置;大小範圍 44–180,位置與大小都會記住。
