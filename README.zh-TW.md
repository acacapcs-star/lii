...
| Toolbox | 心情工具箱,四個工具:自我對話卡、4-7-8 呼吸、5-4-3-2-1 著地、情緒詞彙庫;含練習紀錄 |
...
做完一次練習會在罐子裡留下一顆玻璃球。罐子在頁面頂部，底下的球依日期分組、依顏色堆疊。

### 顏色不是使用者選的，也不是從 ERS 推的

第一版的設計是「做完練習之後選一個顏色」。寫下來就看得出問題：**使用者不知道該選什麼。**「我剛做完著地練習」這件事沒有任何地方指向青色或琥珀色，所以他會點最近的那一個，而那個選擇不帶任何資訊。
